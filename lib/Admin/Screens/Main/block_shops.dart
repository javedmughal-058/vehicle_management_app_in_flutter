...
class _block_shopsState extends State<block_shops> {
  ...
  _unblockshop() async{
    ...
    FirebaseFirestore.instance
        ...
        .update({"type": true}).then((_) {
      print("success!");
      setState(() {
        blockedlist=blockedshoplist();
      });
    });
  }
  bool count=true;
                ...
                child: Container(
                  ...
                  child: loading==true? Center(
                    child: Container(
                      ...
                      :ListView.builder(physics: ClampingScrollPhysics(),shrinkWrap: true,itemCount: blockedlist.length,itemBuilder: (context,index){
                    return  Container(
                      ...
                      child: Row(
                          children: [
                            ...
                            Container(
                              color: Colors.indigo,
                              child: Text("${blockedlist[index]['type']}",style: const TextStyle(
                                color: Colors.white,
                                fontSize: 14,
                            ...
                            Column(
                              children:  [
                                ...
                                Text("${blockedlist[index]['Owner Name']}",style: const TextStyle(
                                  color: Colors.black87,
                                  fontWeight: FontWeight.bold,
                                  fontSize: 12,
                                  fontFamily: 'Shrikhand',
                                ),),
                                Text("Shop Name: ${blockedlist[index]['Shop Name']}",
                                  maxLines: 1,
                                  softWrap: false,
                              ...
                              Row(children: [
                                Text("Affordability: ${blockedlist[index]['Shop Affordability']}",style: const TextStyle(
                                  color: Colors.indigo,
                                  fontSize: 12,
                                  fontFamily: 'Shrikhand',
                                ),),
                                const SizedBox(width: 20,),
                                Text("Rating: ${blockedlist[index]['Shop Rating']}",style: const TextStyle(
                                  color: Colors.orange,
                                  fontSize: 12,
                                  fontFamily: 'Shrikhand',
                                ),),
